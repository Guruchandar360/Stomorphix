    ...
    <div className="bubble result batch-result">
      ...
      {completed && job.summary && (
        <>
          ...
          <div className="artifact-row batch-downloads">
            ...
            <a href={downloadUrl("counts")} download>
              <Download size={14} /> Count reports
            </a>
      ...
      {selectedResult && (
        <div className="batch-detail">
          ...
          />
          <div className="summary-grid batch-detail-metrics count-summary-grid">
          ...
          <div className="artifact-row">
            ...
            <a href={absoluteUrl(apiBase, selectedResult.count_report_url)} download>
              <Download size={13} /> Download count report
            </a>
          </div>
        </div>
      )}
